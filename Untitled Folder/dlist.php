...
<tr bgcolor=b
lue><td align=center><font SIZE=6 color=white>HOSPITAL 
...
<t
r bgcolor=#ccccc><td align=center>S No</td><td align=center>Doctor 
...
<tr bgco
lor=red><td><font size=4 color=white>Deleted 
Records</font></td></tr>
<tr><td><table width=750 cellspacing=0 cellpadding=5>
...
echo "<tr><td>$sno</td><td>$row[1]</td><td>$row[2]</td><td><a 
href=dundel.php?rno=".$row[0].">Undelete</a></td></
tr>";
$sno++;
}
if ($sno==1) echo "<tr><td align=center><font size=4 color=red>Records 
